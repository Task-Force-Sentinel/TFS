...
// Combat - Long Sleeves - TFSRHS
class CLASS(Unit_Combat_LS_TFSRHS_Base): CLASS(Unit_Combat_LS_Base) {
    hiddenSelectionsMaterials[] = {QPATHTOF(data\uniform_combat_TFSRHS.rvmat)};
};
...
// Combat - Rolled Sleeves - TFSRHS
class CLASS(Unit_Combat_RS_TFSRHS_Base): CLASS(Unit_Combat_RS_Base) {
    hiddenSelectionsMaterials[] = {QPATHTOF(data\uniform_combat_TFSRHS.rvmat)};
};
