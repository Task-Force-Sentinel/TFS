...
class CfgPatches {
    class ADDON {
        ...
        units[] = {
            ...
            QCLASS(Item_Uniform_Combat_LS_TFSRHS_ATX),
            QCLASS(Item_Uniform_Combat_LS_TFSRHS_AUX),
            QCLASS(Item_Uniform_Combat_LS_TFSRHS_IX),
            QCLASS(Item_Uniform_Combat_LS_TFSRHS_LEX),
            ...
            QCLASS(Item_Uniform_Combat_RS_TFSRHS_ATX),
            QCLASS(Item_Uniform_Combat_RS_TFSRHS_AUX),
            QCLASS(Item_Uniform_Combat_RS_TFSRHS_IX),
            QCLASS(Item_Uniform_Combat_RS_TFSRHS_LEX),
        ...
        weapons[] = {
            QCLASS(Suit_VIP),
            QCLASS(Uniform_Combat_LS_TFSRHS_ATX),
            QCLASS(Uniform_Combat_LS_TFSRHS_AUX),
            QCLASS(Uniform_Combat_LS_TFSRHS_IX),
            QCLASS(Uniform_Combat_LS_TFSRHS_LEX),
            ...
            QCLASS(Uniform_Combat_RS_TFSRHS_ATX),
            QCLASS(Uniform_Combat_RS_TFSRHS_AUX),
            QCLASS(Uniform_Combat_RS_TFSRHS_IX),
            QCLASS(Uniform_Combat_RS_TFSRHS_LEX),
        ...
        requiredAddons[] = {"TFSRHS_backpacks", "TFSRHS_headgear", "TFSRHS_vests", "TFSRHS_weapons"};
        author = AUTHOR;
