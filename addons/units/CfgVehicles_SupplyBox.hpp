...
class CLASS(Box_Uniforms): B_supplyCrate_F {
    ...
    class TransportItems {
        ...
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_TFSRHS_ATX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_TFSRHS_AUX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_TFSRHS_IX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_TFSRHS_LEX),10);
        ...
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_TFSRHS_ATX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_TFSRHS_AUX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_TFSRHS_IX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_TFSRHS_LEX),10);
