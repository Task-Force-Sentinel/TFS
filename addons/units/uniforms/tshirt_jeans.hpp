...
class CLASS(Uniform_TShirt_NL_JP_GS_LP_BB): CLASS(Uniform_Base) { // L = Blue
    scope = 2;
    author = "Pomigit, Jonpas, Rory";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QCLASS(Unit_TShirt_NL_JP_GS_LP_BB);
    };
};
class CLASS(Uniform_TShirt_NL_JP_GS_TP_BB): CLASS(Uniform_Base) { // L = Blue
    scope = 2;
    author = "Pomigit, Jonpas, Rory";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QCLASS(Unit_TShirt_NL_JP_GS_TP_BB);
    };
};
class CLASS(Uniform_TShirt_NL_JP_BS_LP_BB): CLASS(Uniform_Base) { // L = Blue
    scope = 2;
    author = "Pomigit, Jonpas, Rory";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QCLASS(Unit_TShirt_NL_JP_BS_LP_BB);
    };
};
class CLASS(Uniform_TShirt_NL_JP_BS_TP_BB): CLASS(Uniform_Base) {
    scope = 2;
    author = "Pomigit, Jonpas, Rory";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QCLASS(Unit_TShirt_NL_JP_BS_TP_BB);
    };
};
class CLASS(Uniform_TShirt_NL_JP_LS_LP_BB): CLASS(Uniform_Base) { // L = Blue
    scope = 2;
    author = "Pomigit, Jonpas, Rory";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QCLASS(Unit_TShirt_NL_JP_LS_LP_BB);
    };
};
class CLASS(Uniform_TShirt_NL_JP_WS_LP_BB): CLASS(Uniform_Base) { // L = Blue
    scope = 2;
    author = "Pomigit, Jonpas, Rory";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QCLASS(Unit_TShirt_NL_JP_WS_LP_BB);
    };
};