...
_cueCardsData = [
	...
	[
		"z\tfsrhs\addons\Media\images\cuecards\medivac.paa",
		"CASEVAC Request Card"
	],

	//	1 - Contact Report Card
	[
		"z\tfsrhs\addons\Media\images\cuecards\tic.paa",
		"Contact Report Card"
	],

	// 	2 - CAS Checkin  Card
	[
		"z\tfsrhs\addons\Media\images\cuecards\cascheck.paa",
		"CAS Check IN Card"
	],

	// 	3 - CAS Card
	[
		"z\tfsrhs\addons\Media\images\cuecards\casbrief.paa",
		"CAS Briefing Card"
	],

	// 	4 - Salute Card
	[
		"z\tfsrhs\addons\Media\images\cuecards\salute.paa",
		"(SALUTE) Card"
	],
	// 	5 - ACE Card
	[
		"z\tfsrhs\addons\Media\images\cuecards\ace.paa",
		"(ACE) Card"
	],
	// 	6 - Front Line Trace ( POSREP ) Card
	[
		"z\tfsrhs\addons\Media\images\cuecards\posrep.paa",
		"Front Line Trace ( POSREP ) Card"
	],
	// 	7 - Vehicle Report (DEFREP) Card
	[
		"z\tfsrhs\addons\Media\images\cuecards\venicle.paa",
		"Vehicle Report (DEFREP) Card"
	],
	// 	8 - Bandages
	[
		"z\tfsrhs\addons\Media\images\cuecards\bandages.paa",
		"Bandages Notes"
	],
	// 	9 - Medical Notes
	[
		"z\tfsrhs\addons\Media\images\cuecards\mednotes.paa",
		"Medical Notes"
	],
	// 	10 - Medical Process
	[
		"z\tfsrhs\addons\Media\images\cuecards\medproces.paa",
		"Medical Process"
	],
	// 	11 - Call for Fire
	[
		"z\tfsrhs\addons\Media\images\cuecards\cff.paa",
		"Call for Fire"
	],
	// 	12 - Method of Fire and Control
	[
		"z\tfsrhs\addons\Media\images\cuecards\mfc.paa",
		"Method of Fire and Control"
	],
	// 	13 - Rotary Landing 
	[
		"z\tfsrhs\addons\Media\images\cuecards\landingb.paa",
		"Rotary Landing"
	]
];
