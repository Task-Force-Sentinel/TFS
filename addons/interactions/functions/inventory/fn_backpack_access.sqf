 ...
 *	\z\tfsrhs\addons\interactions\functions\inventory\fn_backpack_access.sqf
 *	by Ojemineh
 *	
 ...
 *	
 *	Example:
 *	[player, unit1] call TFSRHS_interactions_fnc_backpack_access;
 *	
 */
...
if (missionNamespace getVariable ["tfsrhs_interactions_backpack_access_hint", true]) then {
	...
	private _iconFile = "\z\tfsrhs\addons\interactions\data\icons\search_backpack_ca.paa";
	private _icon = format [_iconTemplate, _iconFile];
	private _hintMessage = format [localize "STR_TFSRHS_Interactions_Hint_Backpack_Access", _playerName, _icon];
