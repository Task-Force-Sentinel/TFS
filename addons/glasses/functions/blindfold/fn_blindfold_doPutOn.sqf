 ...
 *	\z\tfsrhs\addons\glasses\functions\blindfold\fn_blindfold_doPutOn.sqf
 *	by Ojemineh
 *
 *	put blindfold on
 *
 ...
 *
 *	Example:
 *	[_player, _target] call TFSRHS_glasses_fnc_blindfold_doPutOn;
 *
 */
...
[_caller, _target] spawn {
	...
	private _blindfolds = ["TFSRHS_Blindfold_Black", "TFSRHS_Blindfold_White", "TFSRHS_Blindfold_White_Blood"];
	...
	if (_googles != "") then {
		...
		[_target, _googles, 1, [1,2,3], true] call TFSRHS_fnc_addItem;
	};
