class CfgGlasses {
	...
	class CLASS(RegulatorMask): G_RegulatorMask_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_RegulatorMask_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_RegulatorMask_Description";
		mass = 6;
		ACE_Color[] = {0,0,0};
	...
	class CLASS(Respirator): G_AirPurifyingRespirator_01_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_Respirator_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_Respirator_Description";
		mass = 7;
		ACE_Color[] = {0,0,0};
		ACE_DustPath = "\z\ace\addons\goggles\textures\fx\dust\%1.paa";
		ACE_Overlay = QPATHTOF(data\hud\mask_01_ca.paa);
	...
	class CLASS(Respirator_Black): G_AirPurifyingRespirator_02_black_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_Respirator_Black_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_Respirator_Black_Description";
		mass = 7;
		ACE_Color[] = {0,0,0};
		ACE_DustPath = "\z\ace\addons\goggles\textures\fx\dust\%1.paa";
		ACE_Overlay = QPATHTOF(data\hud\mask_01_ca.paa);
	...
	class CLASS(Respirator_Olive): G_AirPurifyingRespirator_02_olive_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_Respirator_Olive_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_Respirator_Olive_Description";
		mass = 7;
		ACE_Color[] = {0,0,0};
		ACE_DustPath = "\z\ace\addons\goggles\textures\fx\dust\%1.paa";
		ACE_Overlay = QPATHTOF(data\hud\mask_01_ca.paa);
	...
	class CLASS(Respirator_Sand): G_AirPurifyingRespirator_02_sand_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_Respirator_Sand_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_Respirator_Sand_Description";
		mass = 7;
		ACE_Color[] = {0,0,0};
		ACE_DustPath = "\z\ace\addons\goggles\textures\fx\dust\%1.paa";
		ACE_Overlay = QPATHTOF(data\hud\mask_01_ca.paa);
	...
	class CLASS(Blindfold_Black): G_Blindfold_01_black_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_Blindfold_Black_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_Blindfold_Black_Description";
	...
	class CLASS(Blindfold_White): G_Blindfold_01_white_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_Blindfold_White_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_Blindfold_White_Description";
	...
	class CLASS(Blindfold_White_Blood): G_Blindfold_01_white_F {
		...
		scopeArsenal = 2;
		author = AUTHOR;
		displayName = "$STR_TFSRHS_Glasses_Blindfold_White_Blood_DisplayName";
		descriptionShort = "$STR_TFSRHS_Glasses_Blindfold_White_Blood_Description";
