...
force force ace_medical_treatment_cprSuccessChanceMax = 0.60477;
force force ace_medical_treatment_cprSuccessChanceMin = 0.307048;
...
force force ace_parachute_failureChance = 0.12411;
...
force force AIMEE_inventory_settingOpenActionRange = 4.5;

// AIMEE - UAV and GPS Terminals
force force AIMEE_uav_terminal_GPSAction = true;
...
// TFS Adminmenu
TFS_adminMenu_endLogToRPT = false;
TFS_adminMenu_printToChat = 1;

// TFS AI
force TFS_AI_AimingAccuracy = 0.4;
force TFS_AI_AimingShake = 0.45;
force TFS_AI_AimingSpeed = 0.3;
force TFS_AI_Commanding = 0.9;
force TFS_AI_Courage = 0.9;
force TFS_AI_General = 0.85;
...
// TFS core
tfs_debug_enabled = false;
tfs_showNewsOnMainMenu = true;
...
// TFS Quick Actions
force TFS_quickActions_add_detonator = true;
force TFS_quickActions_add_fast_rope = true;

// TFS Remote Sensors
force TFS_remotesensors_enabled = true;

// TFS Respawn
force force TFS_respawn_enabled = true;
force force TFS_respawn_time = 6;
...
// TFS Weather
force TFS_Weather_DayTimeAcc = 1;
force TFS_Weather_Master = false;
force TFS_Weather_MaxTime = 60;
force TFS_Weather_MinTime = 1;
force TFS_Weather_NightTimeAcc = 1;
force TFS_Weather_RealTime = true;
force TFS_Weather_StartWeather = 1;
force TFS_Weather_SyncTime = 60;
...
force TFS_Zeus_Module_MedicalDummy = false;
