/*
Function: TFSRHS_fnc_GetAvailableFactions
...

{
	...
	private _sideVar = format ["TFSRHS_AvailableFactions_%1", _side];
	...
	if !(isNil _sideVar) then {
		...
		_sideFactions = [nil, ["TFSRHS_AI", format ["%1_Factions", _side]]] call YAINA_F_fnc_GetFunctions;
