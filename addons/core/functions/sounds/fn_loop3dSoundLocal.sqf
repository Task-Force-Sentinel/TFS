...
*	\z\tfs\addons\core\functions\sounds\fn_loop3dSoundlocal.sqf
*	by Ojemineh
*
...
*
*	Example:
*	[player, "AlarmBell", [], -1, -1, 6] call TFS_fnc_loop3dSoundlocal;
*
*/
...
if (_soundinUse) exitwith {
    [_object, _soundClass, _position, _distance, _maxdistance, _duration, _pitch, _isSpeech] spawn {
        ...
        sleep 0.1;
        [_object, _soundClass, _position, _distance, _maxdistance, _duration, _pitch, _isSpeech] call TFS_fnc_loop3dSoundlocal;
    };
};
