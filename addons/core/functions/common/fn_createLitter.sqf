 ...
 *	\z\tfsrhs\addons\core\functions\common\fn_createLitter.sqf
 *	by Ojemineh
 *	
 ...
 *	
 *	Example:
 *	[player, "MedicalGarbage_01_FirstAidKit_F"] call TFSRHS_fnc_createLitter;
 *	
 */
...
if (missionNamespace getVariable ["ace_medical_allowLitterCreation", false]) then {
	[_unit, _className, _offset] remoteExecCall ["TFSRHS_fnc_createLitterServer", 2];
};
