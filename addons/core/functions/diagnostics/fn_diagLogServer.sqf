 ...
 *	\z\tfsrhs\addons\core\functions\diagnostics\fn_diagLogServer.sqf
 *	by Ojemineh
 *	
 ...
 *	
 *	Example:
 *	[4, "Player: '%1', Time: '%2'", [player, time], "core"] call TFSRHS_fnc_diagLogServer;
 *	
 */
...
["tfsrhs_core_diagLog", [_level, _message, _params, _extension, _modification]] call CBA_fnc_serverEvent;
