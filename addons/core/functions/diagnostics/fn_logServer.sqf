...
* \z\tfs\addons\core\functions\diagnostics\fn_logServer.sqf
* by Ojemineh
*
* add a rpt-log
*
...
*
* Example:
* [4, "player: '%1', time: '%2'", [player, time], "core"] call TFS_fnc_logServer;
*
*/
...
["tfs_core_log", [_level, _message, _params, _extension, _modification]] call CBA_fnc_serverEvent;