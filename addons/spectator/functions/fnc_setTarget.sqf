...
switch (GVAR(mode)) do {
    ...
    case FREECAM: {
        ...
        private _newPos = _targetPos vectorAdd ((vectorNormalized (_camPos vectorDiff _targetPos)) vectorMultiply 30);
        /*_camPos vectorAdd ((_targetPos vectorDiff _camPos) vectorMultiply 0.5);*/
