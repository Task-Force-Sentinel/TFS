...
private _control = (_display displayCtrl IDC_TFS_ADMINMENU_RESP_FACTION);  /* Faction Control */
...
private _control = (_display displayCtrl IDC_TFS_ADMINMENU_RESP_ROLECOMBO); /* Role control */ 
lbClear _control;
respawnMenuRoles = [];
{
