...
/* ----------------------------------------------------------------------------
Internal Function: TFSRHS_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call TFSRHS_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_TFSRHS_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[TFSRHS Adminmenu] Printed entry: %1%2",
