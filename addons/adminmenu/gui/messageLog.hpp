class Controls
{
    class BackgroundMessagesList: RscText
    {
        x = 0;
        y = 0;
        w = TFS_ADMINMENU_MSGS_W_LIST;
        h = TFS_ADMINMENU_MSGS_H_LIST;
    ...
    {
        idc = IDC_TFS_ADMINMENU_MSGS_LIST;
    ...
    {
        idc = IDC_TFS_ADMINMENU_MSGS_COPY;
        ...
        x = 0 * TFS_ADMINMENU_STD_WIDTH;
        y = 19.5 * TFS_ADMINMENU_STD_HEIGHT;
        w = 9 * TFS_ADMINMENU_STD_WIDTH;
    };

    class ButtonPrintAll: GVAR(RscButtonMenu)
    {
        idc = IDC_TFS_ADMINMENU_MSGS_COPYALL;
        text = "PRINT ALL TO RPT";
        tooltip = "Prints all logged entries to RPT.";
        onButtonClick = QUOTE(_this call FUNC(messageLog_printAll));
        colorBackground[] = {0, 0, 0, 1};
        x = 9.1 * TFS_ADMINMENU_STD_WIDTH;
        y = 19.5 * TFS_ADMINMENU_STD_HEIGHT;
        w = 7 * TFS_ADMINMENU_STD_WIDTH;
    };
};
